...
const myPokemon = new Pokemon("Pikachu", 5);
      ...
      Pokemon.prototype.tackle = function(targetPokemon) {
        ...
        logToConsoleBox(`${this.name} used Tackle on ${targetPokemon.name}. ${targetPokemon.name}'s health is now ${targetPokemon.health}.`);
      ...
      const tackleHandler = function() {
        ...
        if (enemyPokemon.health <= 0) {
          ...
          logToConsoleBox(`${enemyPokemon.name}'s health is now ${enemyPokemon.health}.`);
        }
      };
